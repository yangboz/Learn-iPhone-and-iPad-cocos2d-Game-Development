...
-(id) init
{
	if ((self = [super init]))
	{
		...
		CCLabel* label = [CCLabel labelWithString:@"Touch Screen to Continue" fontName:@"AmericanTypewriter-Bold" fontSize:20];
...
-(void) createLabelWithOffset:(int)offset
{
	...
	CCLabel* label = [CCLabel labelWithString:@"Hello Cocos2D" fontName:@"AppleGothic" fontSize:64];
