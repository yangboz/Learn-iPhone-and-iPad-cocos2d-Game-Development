...
-(id) initTableWithWorld:(b2World*)world
{
	if ((self = [super init]))
	{
		...
		Flipper* flipperLeft = [Flipper flipperWithWorld:world flipperType:FlipperLeft];
		[self addChild:flipperLeft z:-2];
		Flipper* flipperRight = [Flipper flipperWithWorld:world flipperType:FlipperRight];
